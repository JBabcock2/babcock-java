...
public class Milestone3NFLPlayerMngr {
    ...
    public static void main(String[] args) {
        ...
        List<Defense> dPlayers = new ArrayList<>();
           ...
           // add players method that creates players in array list 
        ...
        //testing array by printing , replacing brackets around array.
        //to.String method included with driver method
